...
void RecursiveLinkedListWrapper_main() {
  ...
  std::cout << rll1.Count("flies") << std::endl;
  std::cout << rll1.Count("arrow") << std::endl;
  std::cout << rll1.Count("blah") << std::endl;
  std::cout << rll1.GetSize() << std::endl;

  std::cout << rll1.IndexOf("arrow") << std::endl;
  std::cout << rll1.IndexOf("blah") << std::endl;

  std::cout << rll1.Pop() << std::endl;

  std::cout << rll1.Get(0) << rll1.Get(1) << rll1.Get(2) << rll1.Get(3) << rll1.Get(4) << std::endl;

  std::cout << rll1.Pop(3) << std::endl;

  std::cout << rll1.Get(0) << rll1.Get(1) << rll1.Get(2) << rll1.Get(3) << rll1.Get(4) << std::endl;

  RecursiveLinkedListWrapper rll2 = RecursiveLinkedListWrapper("Time");
  rll2.Append("flies");
  rll2.Append("like");
  rll2.Append("an");
  rll2.Append("arrow");
	...
	std::cout << rll2.Get(0) << rll2.Get(1) << rll2.Get(2) << rll2.Get(3) << rll2.Get(4) << std::endl;

	rll2.Set("Something", 0);
  std::cout << rll2.ToString() << std::endl;
